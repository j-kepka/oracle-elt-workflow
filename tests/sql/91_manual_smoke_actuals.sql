...
WITH cases AS (
  ...
  UNION ALL
  SELECT 20, 'transfers_2026-03-24_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-24', 'MANUAL' FROM dual
  UNION ALL
  SELECT 30, 'clients_2026-03-25_manual', 'LOAD_CLIENTS', DATE '2026-03-25', 'MANUAL' FROM dual
  UNION ALL
  SELECT 40, 'transfers_2026-03-25_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-25', 'MANUAL' FROM dual
  UNION ALL
  SELECT 50, 'clients_2026-03-26_manual', 'LOAD_CLIENTS', DATE '2026-03-26', 'MANUAL' FROM dual
  UNION ALL
  SELECT 60, 'transfers_2026-03-26_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-26', 'MANUAL' FROM dual
  UNION ALL
  SELECT 70, 'clients_2026-03-27_manual', 'LOAD_CLIENTS', DATE '2026-03-27', 'MANUAL' FROM dual
  UNION ALL
  SELECT 80, 'transfers_2026-03-27_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-27', 'MANUAL' FROM dual
  UNION ALL
  SELECT 90, 'clients_2026-03-28_manual', 'LOAD_CLIENTS', DATE '2026-03-28', 'MANUAL' FROM dual
  UNION ALL
  SELECT 100, 'transfers_2026-03-28_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-28', 'MANUAL' FROM dual
  UNION ALL
  SELECT 110, 'clients_2026-03-29_manual', 'LOAD_CLIENTS', DATE '2026-03-29', 'MANUAL' FROM dual
  UNION ALL
  SELECT 120, 'clients_2026-04-08_manual', 'LOAD_CLIENTS', DATE '2026-04-08', 'MANUAL' FROM dual
  UNION ALL
  SELECT 130, 'transfers_2026-04-08_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-04-08', 'MANUAL' FROM dual
  UNION ALL
  SELECT 140, 'clients_2026-04-09_manual', 'LOAD_CLIENTS', DATE '2026-04-09', 'MANUAL' FROM dual
  UNION ALL
  SELECT 150, 'clients_2026-04-10_manual', 'LOAD_CLIENTS', DATE '2026-04-10', 'MANUAL' FROM dual
  UNION ALL
  SELECT 160, 'transfers_2026-04-10_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-04-10', 'MANUAL' FROM dual
  UNION ALL
  SELECT 170, 'transfers_2026-04-11_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-04-11', 'MANUAL' FROM dual
  UNION ALL
  SELECT 180, 'transfers_2026-04-12_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-04-12', 'MANUAL' FROM dual
),
ctl AS (
  SELECT
    process_name,
