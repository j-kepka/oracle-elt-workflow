...
WITH expected AS (
  ...
  UNION ALL
  SELECT 20, 'clients_2026-03-25_manual', 'LOAD_CLIENTS', DATE '2026-03-25', 'MANUAL', 'WARNING', 'INPUT_VALIDATION_WARNING', 9, 5, 4, 5 FROM dual
  UNION ALL
  SELECT 30, 'clients_2026-03-26_manual', 'LOAD_CLIENTS', DATE '2026-03-26', 'MANUAL', 'DONE', 'LOAD_DONE', 12, 12, 0, 12 FROM dual
  UNION ALL
  SELECT 40, 'clients_2026-03-27_manual', 'LOAD_CLIENTS', DATE '2026-03-27', 'MANUAL', 'FAILED', 'OK_COUNT_INCLUDES_HEADER', 3, 0, 0, 0 FROM dual
  UNION ALL
  SELECT 50, 'clients_2026-03-28_manual', 'LOAD_CLIENTS', DATE '2026-03-28', 'MANUAL', 'DONE', 'LOAD_DONE', 2, 2, 0, 2 FROM dual
  UNION ALL
  SELECT 60, 'clients_2026-03-29_manual', 'LOAD_CLIENTS', DATE '2026-03-29', 'MANUAL', 'WARNING', 'INPUT_VALIDATION_WARNING', 2, 0, 2, 0 FROM dual
  UNION ALL
  SELECT 70, 'clients_2026-04-08_manual', 'LOAD_CLIENTS', DATE '2026-04-08', 'MANUAL', 'FAILED', 'MISSING_OK_MANUAL', CAST(NULL AS NUMBER), 0, 0, 0 FROM dual
  UNION ALL
  SELECT 80, 'clients_2026-04-09_manual', 'LOAD_CLIENTS', DATE '2026-04-09', 'MANUAL', 'WARNING', 'INPUT_VALIDATION_WARNING', 10, 2, 8, 2 FROM dual
  UNION ALL
  SELECT 90, 'clients_2026-04-10_manual', 'LOAD_CLIENTS', DATE '2026-04-10', 'MANUAL', 'DONE', 'LOAD_DONE', 2, 2, 0, 2 FROM dual
  UNION ALL
  SELECT 110, 'transfers_2026-03-24_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-24', 'MANUAL', 'FAILED', 'MISSING_DATA_FILE', 13, 0, 0, 0 FROM dual
  UNION ALL
  SELECT 120, 'transfers_2026-03-25_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-25', 'MANUAL', 'WARNING', 'INPUT_VALIDATION_WARNING', 12, 5, 7, 5 FROM dual
  UNION ALL
  SELECT 130, 'transfers_2026-03-26_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-26', 'MANUAL', 'DONE', 'LOAD_DONE', 20, 20, 0, 20 FROM dual
  UNION ALL
  SELECT 140, 'transfers_2026-03-27_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-27', 'MANUAL', 'FAILED', 'OK_COUNT_MISMATCH', 20, 0, 0, 0 FROM dual
  UNION ALL
  SELECT 150, 'transfers_2026-03-28_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-03-28', 'MANUAL', 'WARNING', 'INPUT_VALIDATION_WARNING', 2, 0, 2, 0 FROM dual
  UNION ALL
  SELECT 160, 'transfers_2026-04-08_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-04-08', 'MANUAL', 'FAILED', 'MISSING_OK_MANUAL', CAST(NULL AS NUMBER), 0, 0, 0 FROM dual
  UNION ALL
  SELECT 170, 'transfers_2026-04-10_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-04-10', 'MANUAL', 'DONE', 'LOAD_DONE', 2, 2, 0, 2 FROM dual
  UNION ALL
  SELECT 180, 'transfers_2026-04-11_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-04-11', 'MANUAL', 'FAILED', 'MISSING_CLIENT_SNAPSHOT', 1, 0, 0, 0 FROM dual
  UNION ALL
  SELECT 190, 'transfers_2026-04-12_manual', 'LOAD_CLIENT_TRANSFERS', DATE '2026-04-12', 'MANUAL', 'WARNING', 'INPUT_VALIDATION_WARNING', 2, 0, 2, 0 FROM dual
),
ctl AS (
  SELECT
    process_name,
