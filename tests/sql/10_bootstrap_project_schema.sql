...
--   DEFINE EXT_DIR_PATH = '/opt/oracle/extdata/inbound'
--   DEFINE EXT_WORK_DIR_PATH = '/opt/oracle/extdata/work'
--   DEFINE EXT_EXPORT_DIR_PATH = '/opt/oracle/extdata/outbound'
...
CREATE OR REPLACE DIRECTORY EXT_EXPORT_DIR AS '&&EXT_EXPORT_DIR_PATH';
GRANT READ ON DIRECTORY EXT_DIR TO dwh;
GRANT READ, WRITE ON DIRECTORY EXT_WORK_DIR TO dwh;
GRANT READ, WRITE ON DIRECTORY EXT_EXPORT_DIR TO dwh;
