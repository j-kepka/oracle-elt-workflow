...
--   extdata/client_transfers_20260328.csv + .ok -> duplicate transfer_id case
...
PROMPT ==================================================
PROMPT Manual smoke review for PR-03
...
PROMPT Expected result: ORA-00001, status=FAILED, reason_code=UNEXPECTED_ERROR
...
BEGIN
  ...
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Expected error for 2026-03-28: ' || SQLCODE || ' ' || SQLERRM);
  END;
END;
/
