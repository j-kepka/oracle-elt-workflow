...
For portfolio/demo purposes, the practical MVP scope is treated as complete before `Phase-09`; optional post-MVP work is currently grouped into `Phase-09`, `Phase-10`, `Phase-11`, and `Phase-12`.
...
- `Phase-05` to `Phase-07` complete the demo-facing AML flow up to a simple mart and spool/export.
- `Phase-08` can still be used for light inbound hardening without changing the demo narrative.
- `Phase-09`, `Phase-10`, `Phase-11`, and `Phase-12` are treated as optional post-MVP work and are not required for a demo-complete portfolio scope.
